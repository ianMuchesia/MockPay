...
const PaymentDetailsPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!businessId || (!subscriptionPlanId && !serviceId)) {
      setModalMessage('Missing required subscription information.');
      setModalType('error');
      setShowModal(true);
      return;
    }
    ...
    try {
      ...
      const payload = {
        ...
        subscriptionPlanId: subscriptionPlanId ? parseInt(subscriptionPlanId) : 0,
      ...
      <div className="bg-red-50 border-l-4 border-red-400 p-6 rounded-lg">
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <p className="text-red-700">Required subscription details are missing.</p>
            <Button 
              variant="outline" 
              className="mt-3" 
              onClick={() => navigate(-1)}
    ...
    <>
      <div className="flex flex-col md:flex-row md:items-center gap-4 mb-6">
        <div className="flex-grow">
          <h1 className="text-2xl font-bold text-neutral-800">Payment Details</h1>
        ...
        <div className="lg:col-span-1">
          <Card>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center pb-4 border-b border-neutral-200">
                <div>
                  ...
                  <p className="font-medium">
                    {subscriptionType === 'PACKAGE' ? 'Package Plan' : 'Standalone Service'}
                  </p>
                </div>
              </div>
              ...
              <div className="flex justify-between items-center pb-4 border-b border-neutral-200">
                <div>
                  <p className="text-neutral-500">Business ID</p>
                  <p className="font-medium text-sm">
                    {businessId?.substring(0, 12)}...
                  </p>
                </div>
              </div>
